...
a. keine Straftaten innerhalb der letzten 4 Wochen bekannt wurden.
b. keine gesundheitlichen Einschränkungen, die die Ausführung des Gewerbes behindern würden, vorliegen.
c. der Inhaber vom Gewerbeamt für geeignet zum Führen eines Gewerbes erachtet wird. In Sonderfällen kann eine medizinisch psychologische Untersuchung (MPU) von einem Psychologen durch das Gewerbeamt angeordnet werden.

(2). Der Inhaber eines Gewerbes ist dazu verpflichtet Straftaten, welche auf dem Gelände des Gewerbes bzw. solche die unmittelbar mit der Gewerblichkeit im Zusammenhang stehen, zu melden.

(3). Eine Veranstaltung wird nur dann zugelassen, wenn ...
a. keine Straftaten innerhalb der letzten 2 Wochen bekannt wurden.

## §2 GewO Veranstaltungen durch Gewerbetreibende

(1). Eine Veranstaltung, die außerhalb der eigenen Geschäftsräume oder außerhalb der regulären Tätigkeiten ausgelegt ist, ist dem Gewerbeamt anzuzeigen. Dabei müssen folgende Formulare mitgebracht werden.
...
a. Kaum/Keine Risiko: Der Veranstalter muss das Event lediglich anmelden.
...
(2). Veranstaltungen nach [[§3 Abs. 1b, 1c]] dürfen nur dann durchgeführt werden, wenn auch das notwendige Sicherheit- und medizinische Personal verfügbar ist.
...
(6). Für das Hestellen von Betriebsmitteln ist eine _Herstellungslizenz_ erforderlich.
...
(11). Um Gebäude planen und errichten zu dürfen, ist eine _Architektenlizenz_ und eine _Baugenehmigung_ (individiuelle Kosten) erfoderlich.
...
!!!info
Soll die gewerbliche Tätigkeit um einen lizenzpflichtigen Bereich erweitert werden, muss das **vor Ausführung der neuen Tätigkeit** dem Gewerbeamt gemeldet werden.
!!!

(13). Die Kosten sowie die Zahlungsintervalle sind Gesetzlich geregelt:
...
(2). Sachgemäße Lagerung von Lebensmitteln.
(3). Sauberkeit der Gewerbeflächen und Gerätschaften.
(4). Einhaltung der persönlichen Hygiene der Mitarbeiter.

## §7 GewO Ausübung einer gewerblichen Tätigkeit

(1). Um gewerbliche Tätigkeiten auszuüben sind alle für die Tätigkeit notwendigen Lizenzen [[§5 GewO]] und Freigaben vom Gewerbeamt notwendig.
(2). Inhaber und sonstige Stellvertreter eines Gewerbes dürfen keine Straftaten (auch außerhalb der gewerblichen Tätigkeit) durchführen. Die Meldung einer Straftate eines Gewerbeinhabers wird durch die Bundespolizei dem Gewerbeamt gemeldet.
...
(1). Die Zahlung von Lizenzen und Pacht ist pünktlich, oder auch bis zu 3 Zahlungsintervalle im Voraus beim Finanz- und Gewerbeamt zu entrichten. Eine Zahlung ist dann überfällig, wenn diese einen kompletten Zahlungsintervall im Rückstand ist. (Zahlungsverzug). 
...
(1). Strikes verfallen automatisch nach 3 Monaten ohne Wiederholungen des gleichen Strikegrundes und können nicht eigenständig durch die Gewerbetreibenden abgebaut werden. 
(2). Vorhande Strikes werden bei einer Übernahme eines Gewerbes automatisch gelöscht.

## §13 GewO Beendigung einer gewerblichen Tätigkeit

(1). Soll das Gewerbe durch den Gewerbetreibenden beendet werden, muss dies dem Gewerbeamt angezeigt werden. Alle Verpflichtungen, Rechte und Kosten entfallen sofort.
...
(3). Das Gewerbe darf nicht dauerhaft von einer anderen, als beim Gewerbeamt als Geschäftsführer gemeldeten, Person geleitet werden.